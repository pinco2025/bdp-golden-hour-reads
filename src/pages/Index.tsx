...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>BDP Publications | Discover Your Next Great Read</title>
        <meta name="description" content="Curated ebooks that inspire, educate, and transport you to new worlds. Discover your next favorite book with BDP Publications." />
        <meta property="og:title" content="BDP Publications | Discover Your Next Great Read" />
        <meta property="og:description" content="Curated ebooks that inspire, educate, and transport you to new worlds. Discover your next favorite book with BDP Publications." />
        <meta property="og:image" content="/logo/bdploog.png" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="BDP Publications | Discover Your Next Great Read" />
        <meta name="twitter:description" content="Curated ebooks that inspire, educate, and transport you to new worlds. Discover your next favorite book with BDP Publications." />
        <meta name="twitter:image" content="/logo/bdploog.png" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <html lang="en" />
      </Helmet>
      <Layout>
        <div className="min-h-screen">
      {/* Featured Books Section is now at the top. Duplicate section removed. */}

      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden mt-0">
        {/* Dynamic wallpaper is now handled globally. Overlays for readability remain. */}
  {/* Overlay for text readability. Turquoise/teal theme active. */}
  <div className="absolute inset-0 bg-black/30 pointer-events-none" />
        ...
        <div className="relative z-10 text-center max-w-4xl px-6">
          <div className="mb-8 flex justify-center">
            <img
              ...
              alt="BDP Publications logo, a stylized open book with golden hour colors"
              className="w-28 h-28 rounded-full object-cover border-4 border-white shadow-warm bg-white/80"
              style={{ aspectRatio: '1/1' }}
              loading="eager"
              aria-label="BDP Publications logo"
            />
          </div>
      ...
      <section id="genres" className="relative py-16 px-6 overflow-hidden">
        <div className="absolute inset-0 bg-background/80 backdrop-blur-sm pointer-events-none" />
        <div className="relative z-10 max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-foreground text-center" style={{ fontFamily: 'Playfair Display, serif' }}>
            Browse by Genre
          </h2>
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            {['Fiction', 'Non-Fiction', 'Self-Help', 'Romance', 'Mystery', 'Fantasy', 'Science', 'History', 'Poetry', 'Children'].map((genre) => (
              <span key={genre} className="px-5 py-2 rounded-full bg-primary/10 text-primary font-medium text-base shadow-sm hover:bg-primary/20 transition-colors cursor-pointer">
                {genre}
              </span>
            ))}
          </div>
      ...
      <section id="new-releases" className="relative py-16 px-6 overflow-hidden">
        <div className="absolute inset-0 bg-secondary/40 backdrop-blur-sm pointer-events-none" />
        <div className="relative z-10 max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-foreground text-center" style={{ fontFamily: 'Playfair Display, serif' }}>
            New Releases
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {featuredBooks.slice(0, 3).map((book, idx) => (
              <Card key={idx} className="bg-white/80 backdrop-blur-md shadow-lg border-0 transition-transform hover:-translate-y-2 hover:shadow-xl duration-300">
      ...
      <section id="featured-books" className="relative py-20 px-6 overflow-hidden">
        {/* Dynamic wallpaper is now handled globally. Overlay for readability remains. */}
        <div className="absolute inset-0 bg-secondary/60 backdrop-blur-sm pointer-events-none" />
      ...
      <section className="relative py-20 px-6 overflow-hidden">
        {/* Dynamic wallpaper is now handled globally. Overlay for readability remains. */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary/70 to-accent/60 pointer-events-none" />
      ...
      <footer className="relative bg-card/90 backdrop-blur-md py-12 px-6 border-t border-border/50 overflow-hidden">
        {/* Dynamic wallpaper is now handled globally. Subtle overlay remains. */}
        <div className="relative z-10 max-w-6xl mx-auto">
